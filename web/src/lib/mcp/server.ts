...
export const BESEDY_MCP_INSTRUCTIONS = [
  ...
  'Meaning-based search is ranked and non-exhaustive. Literal totalMatches covers the complete authorized catalog, filters, and match mode before result caps.',
  'Verify important search evidence by passing its transcriptRequest to get_transcript and reading coherent continuous context.',
  'Recordings linked to the same event are variants, not independent evidence; support recurring themes with distinct events.',
