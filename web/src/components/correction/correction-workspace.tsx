...
// The correction page shell: the layout gate, the deliberate start action and
// the progress summary. The working surface itself lives in
// correction-surface.tsx.
